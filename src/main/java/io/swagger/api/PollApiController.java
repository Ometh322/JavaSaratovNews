...
public class PollApiController implements PollApi {
    ...
    public ResponseEntity<Void> deletePoll(@ApiParam(value = "Poll ID to delete",required=true) @PathVariable("pollId") Long pollId) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Polls> getPollById(@ApiParam(value = "ID of Poll to return",required=true) @PathVariable("pollId") Long pollId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Polls>(objectMapper.readValue("\"\"", Polls.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Void> updatePoll(@ApiParam(value = "ID of Poll that need to be updated",required=true) @PathVariable("pollId") Long pollId,@ApiParam(value = "Polls object that needs to be updated" ,required=true )  @Valid @RequestBody Polls body) {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<Void>(HttpStatus.NOT_IMPLEMENTED);
    }
